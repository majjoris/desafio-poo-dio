...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Euller:" + dev1.getConteudosInscritos());
        dev1.progredir();
        dev1.progredir();
        System.out.println("--");
        System.out.println("Conteúdos Inscritos Euller:" + dev1.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Euller:" + dev1.getConteudosConcluidos());
        ...
        System.out.println("--");
        System.out.println("Conteúdos Inscritos Joao:" + dev2.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Joao:" + dev2.getConteudosConcluidos());
